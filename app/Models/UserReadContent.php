...
use App\Models\Builders\UserReadContentBuilder;
 ...
 * 
 * Methods
 * @method static UserReadContentBuilder query()
 * @method UserReadContentBuilder newEloquentBuilder($query)
 *
 ...
 **/
class UserReadContent extends BaseModel
{
    use SoftDeletes;
    //
    ...
    /**
     * @return UserReadContentBuilder
     */
    public static function query(): UserReadContentBuilder
    {
        return parent::query();
    }
     ...
     * @return UserReadContentBuilder
     */
    public function newEloquentBuilder($query): UserReadContentBuilder
    {
        return new UserReadContentBuilder($query, $this);
    }
}
