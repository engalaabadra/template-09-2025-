...
/**
 * Class UserSavedContentBuilder
 *
 * Custom Eloquent builder for the UserSavedContent model.
 ...
 *
 * @mixin UserSavedContent
 */
class UserSavedContentBuilder extends BaseBuilder
{
 
    /**
     * Define the available filters that can be applied on UserSavedContent queries.
     *
