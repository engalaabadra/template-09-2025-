...
/**
 * Class UserReadContentBuilder
 *
 * Custom Eloquent builder for the UserReadContent model.
 ...
 *
 * @mixin UserReadContent
 */
class UserReadContentBuilder extends BaseBuilder
{
 
    /**
     * Define the available filters that can be applied on UserReadContent queries.
     *
